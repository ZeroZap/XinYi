...
class ZSerialGuiShellTests(unittest.TestCase):
    ...
    def test_offscreen_smoke_runs_or_reports_missing_qt(self):
        try:
            ...
            self.assertIn("window_controls_present=true", lines)
            ...
            self.assertIn("color_picker_initial_preview=true", lines)
            self.assertIn("color_picker_updates_preview=true", lines)
            self.assertIn("color_picker_default_preview=true", lines)
            ...
            self.assertIn("filter_summary_hidden=true", lines)
