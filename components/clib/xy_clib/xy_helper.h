 ...
 */
static inline int xy_clz(uint32_t value)
{
...
/**
 * @brief Get number of trailing zeros
 * @param value Input value
 * @return Number of trailing zeros
 */
static inline int xy_ctz(uint32_t value)
{
    if (value == 0) return 32;
...
/**
 * @brief Get number of set bits (population count)
 * @param value Input value
 * @return Number of set bits
 */
static inline int xy_popcount(uint32_t value)
{
    int count = 0;
    while (value) {
        count += value & 1;
 ...
 */
static inline xy_size_t xy_strlen(const char *str)
{
    if (!str) return 0;
 ...
 */
static inline char *xy_strcpy(char *dest, const char *src)
{
 ...
 */
static inline int xy_strcmp(const char *s1, const char *s2)
{
    if (!s1 || !s2) {
 ...
 */
static inline char *xy_strchr(const char *str, int c)
{
    if (!str) return NULL;
 ...
 */
static inline char *xy_strrchr(const char *str, int c)
{
    if (!str) return NULL;
