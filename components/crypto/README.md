...
| `crypto_lwc` | Focused test-only LWC contracts; Ascon-128 and Ascon-128a now cover rate-boundary roundtrips with AD, tampered-tag rejection, bounded wipe, and adjacent-byte preservation |
