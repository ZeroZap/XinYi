...
| `crypto_lwc` | Focused test-only LWC contracts; Ascon/TinyJambu variants and Photon-Beetle cover rate-boundary roundtrips, tampered tags, pointer/length guards, bounded wipe, and adjacent-byte preservation |
