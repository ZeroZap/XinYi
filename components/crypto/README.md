...
| `crypto_lwc` | Focused test-only LWC contracts; Ascon-128 now roundtrips lengths 1/7/8/9/16 with AD, rejects tampered tags, wipes only the requested plaintext span, and preserves adjacent bytes |
