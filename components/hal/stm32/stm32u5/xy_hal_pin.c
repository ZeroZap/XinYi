/**
 * @file xy_hal_pin.c
 * @brief GPIO/Pin HAL STM32U5 Implementation
 * @version 2.0
 * @date 2026-02-28
 */
...
/**
 * @brief Get EXTI IRQ number for pin
 */
static IRQn_Type get_pin_irqn(uint8_t pin)
{
    IRQn_Type irqn;
    switch (pin) {
    case 0:
                                     ...
                                     void *arg)
{
    ...
    IRQn_Type irqn = get_pin_irqn(pin);
...
/**
 * @brief GPIO EXTI falling edge callback (called from HAL)
 */
