...
int xy_ads1115_read_single(xy_ads1115_t *dev, uint8_t channel, int16_t *value)
{
    if (dev == NULL || value == NULL || dev->initialized == 0U
        || dev->i2c_dev.base.initialized == 0U || dev->i2c_dev.i2c_handle == NULL || channel > 3U) {
        return XY_ADS1115_INVALID_PARAM;
    }
...
{
    if (dev == NULL || dev->initialized == 0U || dev->i2c_dev.base.initialized == 0U ||
        dev->i2c_dev.i2c_handle == NULL || pga > ADS1115_PGA_0_256V) {
        return XY_ADS1115_INVALID_PARAM;
    }
    dev->pga = pga;
    return XY_ADS1115_OK;
...
{
    if (dev == NULL || dev->initialized == 0U || dev->i2c_dev.base.initialized == 0U ||
        dev->i2c_dev.i2c_handle == NULL || dr > ADS1115_DR_860SPS) {
        return XY_ADS1115_INVALID_PARAM;
    }
    dev->dr = dr;
    return XY_ADS1115_OK;
