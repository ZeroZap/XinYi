...
RIL是一款专门为嵌入式平台开发的无线通信模组(GSM/GPRS/CatM1/NB-Iot)管理软件。它与其它大型框架(例如Android RIL、Wince RIL)不同的是，它被设计成应用于资源受限物联网终端设备（单片机+无线模组的方案），并提供物联网通信所需的基本功能，包含网络注册、连接管理、短信收发及Socket通信。目前已支持EC21、BG96、 HL8518等模组，相关的应用也在持续更新中。
...
## 软件架构
![软件架构图](docs/images/SoftwareArchDiagram-zh.png)
## 开发指南
```c
#include "ril.h"
//....
...
```
更多详细的使用说明，请参考：
- [快速上手](http://moluo-tech.gitee.io/ril/#/)
- [案例演示](http://moluo-tech.gitee.io/ril/#/caseShow)
- [OS移植文档](http://moluo-tech.gitee.io/ril/#/OSPorting)
- [模组适配文档](http://moluo-tech.gitee.io/ril/#/modulePorting)
