...
| `drivers/sensor` Device 路径 | B | SHT30/MPU6050/BMP280/ADS1115/AHT30/L3G4200D/BME680/BH1750/HMC5883L 共 9 个 Device-model canonical owner，均进入 root Sensor target 并有 focused Host 契约 | legacy compatibility wrapper 与其余 experimental source 尚待逐步收敛；全部仍缺完整 B1/B2 | 维持 Device-model canonical owner 决策，禁止第四套生命周期；按芯片迁移兼容边界 |
