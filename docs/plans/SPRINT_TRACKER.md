...
| S0-04 | P0 | 建立 Kconfig/CMake 配置组合矩阵 | IN_PROGRESS | Zero | S0-03（DONE） | [矩阵](../validation/kconfig-cmake-configuration-matrix.md)已建立；非法 Display 组合 fail-closed，OLED/SSD1306 与 LCD SPI/I8080/ST7789 合法组合的生成值、`xy_drivers` 构建和归档 source inventory 通过；全关/逐组件/LED/RGB/Sensor/STM32U5 组合待闭环 | `cc1b3b75`, `5375c930`, `e918c375` | 2026-08-23 |
