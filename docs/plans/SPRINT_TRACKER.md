...
| S0-04 | P0 | 建立 Kconfig/CMake 配置组合矩阵 | IN_PROGRESS | Zero | S0-03（DONE） | [矩阵](../validation/kconfig-cmake-configuration-matrix.md)已建立；首个 Display 非法子功能组合 fail-closed，parser 4/4、Host 178/178、PC build 通过；全关/逐组件/合法 Display/Sensor/STM32U5 组合待闭环 | `cc1b3b75` | 2026-08-23 |
