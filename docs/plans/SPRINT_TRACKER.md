...
| S0-04 | P0 | 建立 Kconfig/CMake 配置组合矩阵 | IN_PROGRESS | Zero | S0-03（DONE） | [矩阵](../validation/kconfig-cmake-configuration-matrix.md)已建立；Display 全组合与 all-off 最小配置已闭环，关闭组件不再泄漏 root target；逐组件/Sensor/STM32U5 组合待闭环 | `cc1b3b75`, `5375c930`, `e918c375`, `6b951a0d`, `bb651cdb` | 2026-08-24 |
