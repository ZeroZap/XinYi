...
| S1-03 | P1 | 字体清单、生成器与 Host snapshot 收口 | IN_PROGRESS | Zero | S1-01（DONE） | 当前 3 个 legacy 字体资产的清单与 source SHA-256 已固定；generator/check-in preview 无漂移、Host snapshot artifact 可复核；仍待人工 snapshot 结论及 license/provenance review，不提前升级资产状态 | pending commit | 2026-08-25 |
