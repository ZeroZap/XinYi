...
| S0-04 | P0 | 建立 Kconfig/CMake 配置组合矩阵 | IN_PROGRESS | Zero | S0-03（DONE） | [矩阵](../validation/kconfig-cmake-configuration-matrix.md)已建立；Display 全组合、all-off、Device/Crypto/DM/Sensor/Actuator-only 已闭环，Sensor/Actuator 的双入口均确认映射各自同一 root target；STM32U5 默认组合待闭环 | `cc1b3b75`, `5375c930`, `e918c375`, `6b951a0d`, `bb651cdb`, `c13a5059`, `f9a72eb6`, `6d012701`, `d7999308` | 2026-08-24 |
