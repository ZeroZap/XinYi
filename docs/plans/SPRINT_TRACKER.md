...
| S2-75 | P0 | LPS22HB deinit 停止错误传播与 ready 保留 | IN_PROGRESS | Zero | S2-74（DONE）；硬件测试按用户要求暂停 | TDD RED 覆盖 stop 写失败时 deinit 不得伪成功或清除 initialized；修复与 focused/full Host、PC/L4/U5 compile 进行中 | 本工作树 | 2026-09-12 |
