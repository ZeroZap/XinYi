...
| S0-04 | P0 | 建立 Kconfig/CMake 配置组合矩阵 | IN_PROGRESS | Zero | S0-03（DONE） | [矩阵](../validation/kconfig-cmake-configuration-matrix.md)已建立；Display 全组合、all-off、Device-only 与 Crypto-only 组合已闭环，关闭组件不再泄漏 root target；DM/Sensor/Actuator/STM32U5 组合待闭环 | `cc1b3b75`, `5375c930`, `e918c375`, `6b951a0d`, `bb651cdb`, `c13a5059` | 2026-08-24 |
