...
| 驱动 | 类型 | 接口 | 代码量 | 状态 |
|------|------|------|--------|------|
| **DHT11** | 温湿度 | GPIO | 7.3KB | ✅ 完成 |
| **SHT40** | 温湿度 | I2C | 6KB | ✅ 完成 |
| **BMI088** | 6 轴 IMU | SPI | 21KB | ✅ 完成 |
| **VL53L1X** | ToF 测距 | I2C | 30KB | ✅ 完成 |
| **LPS22HB** | 气压 | I2C/SPI | 25KB | ✅ 完成 |
| **SGP40** | VOC 气体 | I2C | 18.5KB | ✅ 完成 |
| **W25Qxx** | SPI Flash | SPI | 14.6KB | ✅ 完成 |
| **WS2812** | RGB LED | GPIO | 9.2KB | ✅ 完成 |
| **RC522** | RFID | SPI | 14.6KB | ✅ 完成 |
| **其他** | 多种 | 多种 | ~10KB | ✅ 完成 |
