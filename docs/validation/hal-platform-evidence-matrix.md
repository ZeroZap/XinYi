...
`COMPILE_ONLY`。2026-09-02 已通过 ST-Link 完成 image write/verify，但打开板载 VCP 后 ST-Link
从 USB 掉线，未取得串口 runtime 日志；详见
[Pandora board smoke record](xinyi-pandora-stm32l475-board-smoke-record.md)。因此烧录验证仍不升级为
B1/B2，串口 banner、按键、LED 与 AHT10 数据须保留原始日志/观察记录后才能升级。
