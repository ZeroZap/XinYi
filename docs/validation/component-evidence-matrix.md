...
| DM | H1（7 目标；FS lifecycle/path/I/O/error contract，coreJSON parser/search） | PC build | pending | durability pending | Host 数据格式、FS abstraction 与 NVM 契约 | `xy_json` dedicated test + 掉电/布局恢复 B2 |
