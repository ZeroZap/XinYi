...
| GUI | H1（2026-08-24：backend 错误传播） | PC build | pending | visual/performance pending | Host GUI/font/backend contract；init/clear/draw/fill/flush backend 错误不再归一化为成功 | SDL strict selection + 屏幕 B1/P1 |
