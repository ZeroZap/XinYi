...
- Test evidence:
  - `crypto_lwc` covers Ascon encrypt variants/hash, Ascon-128/128a/80pq multi-length roundtrip/bad-tag/bounded-wipe behavior, TinyJambu-128 multi-length roundtrip/bad-tag/bounded-wipe behavior, and Photon-Beetle 128/64-bit tag roundtrip/tamper/NULL-guard/bounded-wipe plus hash behavior.
