...
| `tests/unit/gui/test_gui_ssd1306_adapter.c` | `unity` | 0 | GUI to SSD1306 display-driver adapter contract; host-only mono mapping/flush bus-failure propagation/multi-instance/slot-exhaustion guard, not hardware validation. |
