...
| `sensor_stub_accel_sensors` | `tests/unit/sensor/test_stub_accel_sensors.c` | GD30DF, QMA6100; former DMP6100/CMS/HS-ADS1100 entries retired after protocol provenance audit |
