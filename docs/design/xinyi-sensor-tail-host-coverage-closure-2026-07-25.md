...
| `sensor_stub_accel_sensors` | `tests/unit/sensor/test_stub_accel_sensors.c` | CMS, GD30DF, HS-ADS1100, QMA6100; former DMP6100 entry retired after protocol provenance audit |
