...
| `sensor_stub_accel_sensors` | `tests/unit/sensor/test_stub_accel_sensors.c` | QMA6100; former DMP6100/CMS/HS-ADS1100/GD30DF entries retired after protocol provenance audit |
