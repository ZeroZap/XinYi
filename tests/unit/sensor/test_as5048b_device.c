...
{
    xy_as5048b_t dev;
    xy_as5048b_sample_t output = {.angle_raw = 0xAAAAU, .timestamp = 7U};
    xy_as5048b_sample_t snapshot = output;
    unsigned before;
    int bus;
    ...
    TEST_ASSERT_EQUAL_INT(XY_DEVICE_INVALID_PARAM, xy_as5048b_read(&dev, &output));
    TEST_ASSERT_EQUAL_INT(XY_DEVICE_INVALID_PARAM, xy_as5048b_deinit(&dev));
