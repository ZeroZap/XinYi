...
def main() -> int:
    ...
    require(len(legacy) == 42, f"expected 42 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=42 experimental_test_only=17 "
