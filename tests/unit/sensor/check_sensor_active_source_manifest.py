...
def main() -> int:
    ...
    require(len(legacy) == 41, f"expected 41 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=41 experimental_test_only=17 "
