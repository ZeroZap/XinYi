...
def main() -> int:
    ...
    require(len(legacy) == 54, f"expected 54 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=54 experimental_test_only=17 "
