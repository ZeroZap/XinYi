...
def main() -> int:
    ...
    require(len(legacy) == 51, f"expected 51 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=51 experimental_test_only=17 "
