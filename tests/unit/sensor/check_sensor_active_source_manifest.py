...
def main() -> int:
    ...
    require(len(legacy) == 52, f"expected 52 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=52 experimental_test_only=17 "
