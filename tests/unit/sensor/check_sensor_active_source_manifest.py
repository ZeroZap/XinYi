...
def main() -> int:
    ...
    require(len(legacy) == 53, f"expected 53 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=53 experimental_test_only=17 "
