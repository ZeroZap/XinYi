...
def main() -> int:
    ...
    require(len(experimental) == 21,
            f"expected 21 experimental xy_* sources, found {len(experimental)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=55 experimental_test_only=21 "
