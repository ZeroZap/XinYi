...
def main() -> int:
    ...
    require(len(legacy) == 50, f"expected 50 legacy active sources, found {len(legacy)}", errors)
    ...
    print("sensor_active_source_manifest_ok legacy_active=50 experimental_test_only=17 "
