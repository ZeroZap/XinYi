...
void setUp(void){memset(id,0,sizeof(id));memset(raw,0,sizeof(raw));status=0;gain_reg=0x20U;read_result=write_result=init_result=init_without_handle=0;writes=0;}
void tearDown(void){}
