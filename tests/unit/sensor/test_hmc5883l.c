...
int main(void){UNITY_BEGIN();RUN_TEST(test_identity_and_config);RUN_TEST(test_wrong_identity_rejected);RUN_TEST(test_xyz_reorder_and_atomic_error);RUN_TEST(test_ready);RUN_TEST(test_gain_validation_and_transport);RUN_TEST(test_field_conversion);RUN_TEST(test_read_overflow_preserves_output);RUN_TEST(test_read_field_preserves_all_public_state_on_gain_failure);RUN_TEST(test_read_field_preserves_all_public_state_on_gain_transport_error);RUN_TEST(test_init_identity_failure_clears_nested_lifecycle);RUN_TEST(test_deinit_clears_transport);RUN_TEST(test_init_config_failure_is_atomic);RUN_TEST(test_init_helper_failure_clears_nested_lifecycle);return UNITY_END();}
