...
static void test_lsm6dso_i2c_accel_gyro_init_read_helpers_and_errors(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT8(LSM6DSO_ACCEL_RATE_208Hz, ((lsm6dso_priv_t *)accel->priv_data)->accel_rate);
    ...
    TEST_ASSERT_EQUAL_UINT8(LSM6DSO_GYRO_RATE_208Hz,
                            ((lsm6dso_priv_t *)accel->priv_data)->gyro_rate);
