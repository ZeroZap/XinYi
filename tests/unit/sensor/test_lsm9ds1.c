...
static void test_lsm9ds1_init_propagates_reset_failure_without_cache_updates(void)
{
    int fake_bus;
    sensor_device_t *accel = lsm9ds1_create_accel("lsm9-reset-fail", &fake_bus);
    lsm9ds1_priv_t *priv;
    ...
    TEST_ASSERT_EQUAL_UINT32(51000U, g_tick);
